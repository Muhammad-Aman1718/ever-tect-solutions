          ...
          <ul className="flex items-center justify-evenly gap-4">
            {["Home", "Courses", "Services", "About Us", "Contact Us"].map(
              (item, idx) => (
                <li
                  key={idx}
                  className="px-4 py-2 rounded-md text-[#18191F] text-[16px] font-medium transition-all duration-300 ease-in-out hover:bg-[#2A75BB] hover:text-white hover:cursor-pointer "
                >
                  {item}
                </li>
              )
